...
def generate_latex_table(results):
    ...
    table += "\\bottomrule \\\n"
    table += "\\end{tabular} \n"
    table += "\\caption{Resource utilization for hardware-software designs using the Codesign-target} \n"
    table += "\\label{tab:res_util_codesign}"
    table += "\\end{table} \n"
...
if __name__ == "__main__":
    ...
    selected_tests = ("LUT", "FF", "Delay", "BRAM")
